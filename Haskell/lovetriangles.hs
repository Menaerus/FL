...
partialSolve currentMax currentResultList (column:list) 
    | otherwise     = let
                        ...
                        maxDone = Main.max (maxTriangleSize newResultList) currentMax
                        notDone = filterNotDone newResultList
                        newMax = Main.max (maxTriangleSize notDone) maxDone
                      in 
...
solves initMax initList list = Main.max (partialSolve initMax initList list) (partialSolve initMax initList (reverse list))
